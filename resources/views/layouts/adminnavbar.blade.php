            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{route('admin.addemployee')}}">New Employee</a>
                        <a class="dropdown-item" href="{{route('admin.viewemployee')}}">View Users</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{route('admin.addphone')}}">Add New Phone</a>
                        <a class="dropdown-item" href="{{route('admin.viewphones')}}">All Phones</a>
                    </div>
                </li>
            </ul>
